...
# Compiling lc-gpu-wrapper-compatible.cu into .so file:

`nvcc -shared -O3 -arch=$(CUDA_ARCH) -fmad=false -DUSE_GPU -Xcompiler "-O3 -march=native -fopenmp -mno-fma -ffp-contract=off -fPIC" -I. -o lc.so lc.cu`
